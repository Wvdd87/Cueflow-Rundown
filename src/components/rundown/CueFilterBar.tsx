...
export function CueFilterBar({ columns, cues, cells, filters, onChange }: CueFilterBarProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap px-[22px] py-2 border-b border-[#1d1d24] bg-[#0b0b10]">
      <div ref={containerRef} className="relative shrink-0">
        <button
          data-testid="filter-btn"
          onClick={() => setOpen((o) => !o)}
          className={cn(
            'inline-flex items-center gap-1.5 h-8 px-3 font-cond text-[10.5px] font-bold uppercase tracking-[0.12em] border transition-colors cursor-pointer',
            active
